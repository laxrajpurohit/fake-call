...
//        guard let _ = (scene as? UIWindowScene) else { return }
        ...
        if Constants.USERDEFAULTS.value(forKey: "startUp") == nil {
            makeRootVC(storyBoardName: "On Boadrding", vcName: "OnBoadingVC")
        } else {
            makeRootVC(storyBoardName: "Main", vcName: "HomeVC")
        }
        
        if Constants.USERDEFAULTS.value(forKey: "LastUpdateDate") == nil {
