...
@objcMembers public class MTSlideToOpenView: UIView {
    // MARK: All Views
    public let textLabel: GranibleLabel = {
        let label = GranibleLabel() // Initialize your custom subclass of UILabel

        label.layer.zPosition = 1

        // Customize additional properties of your custom label if needed
        label.font = UIFont.systemFont(ofSize: Utils().IpadorIphone(value: 18.0), weight: .semibold)
    ...
    public var sliderBackgroundColor: UIColor = UIColor(red:0.1, green:0.61, blue:0.84, alpha:0.1) {
        didSet {
            ...
            sliderHolderView.addBlurToView()
    ...
    public var textColor:UIColor = UIColor(red:25.0/255, green:155.0/255, blue:215.0/255, alpha:0.7) {
        didSet {
            textLabel.colors = [UIColor.red, UIColor.orange]
        }
    }
    ...
    public var textFont: UIFont = UIFont.systemFont(ofSize: Utils().IpadorIphone(value: 18.0), weight: .semibold) {
        didSet {
    ...
    private func setupConstraint() {
        ...
        textLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: CGFloat(50)).isActive = true
